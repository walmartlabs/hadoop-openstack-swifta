...
public class TestSwiftObjectPath implements SwiftTestConstants {
  ...
  public void testParsePath() throws Exception {
    ...
    final SwiftObjectPath actual =
        new SwiftObjectPath(RestClientBindings.extractContainerName(uri), pathString);
  ...
  public void testParseUrlPath() throws Exception {
    ...
    final SwiftObjectPath expected = SwiftObjectPath.fromPath(uri, path);
    final SwiftObjectPath actual =
        new SwiftObjectPath(RestClientBindings.extractContainerName(uri), "/home/user/files/file1");
  ...
  public void testParseAuthenticatedUrl() throws Exception {
    ...
    final Path path = new Path(pathString);
    final SwiftObjectPath expected = SwiftObjectPath.fromPath(uri, path);
    final SwiftObjectPath actual = new SwiftObjectPath(RestClientBindings.extractContainerName(uri),
