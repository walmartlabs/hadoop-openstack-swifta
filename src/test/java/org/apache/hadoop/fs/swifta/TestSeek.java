 ...
 * <li>When you seek past the end of a file, it's an error that should raise -what- EOFException?</li>
 ...
 * </ol>
 * These may seem "obvious", but the more the input streams try to be clever about offsets and buffering, the more likely it is that seek() will start to get confused.
 */
public class TestSeek extends SwiftFileSystemBaseTest {
  protected static final Log LOG = LogFactory.getLog(TestSeek.class);
  ...
  public void testPositionedBulkReadDoesntChangePosition() throws Throwable {
    ...
    assertTrue(-1 != instream.read());
    assertEquals(40001, instream.getPos());

    // Block logic, has been discarded.
  }
