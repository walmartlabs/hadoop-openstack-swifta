...
/**
 * Build a duration stats table to which you can add statistics. Designed to be multithreaded
 */
public class DurationStatsTable {

  private Map<String, DurationStats> statsTable = new HashMap<String, DurationStats>(6);
