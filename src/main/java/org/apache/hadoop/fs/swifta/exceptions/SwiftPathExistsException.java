...
/**
 * Exception raised when trying to create a file that already exists and the overwrite flag is set
 * to false.
 */
public class SwiftPathExistsException extends SwiftException {

  private static final long serialVersionUID = 8582348113364030746L;
