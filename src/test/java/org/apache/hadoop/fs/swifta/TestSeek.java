 ...
 * <li>When you seek past the end of a file, it's an error that should raise -what-
 * EOFException?</li>
 ...
 * </ol>
 * These may seem "obvious", but the more the input streams try to be clever about offsets and
 * buffering, the more likely it is that seek() will start to get confused.
 */
