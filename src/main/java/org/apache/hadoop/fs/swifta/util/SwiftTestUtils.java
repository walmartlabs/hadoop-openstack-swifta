...
public class SwiftTestUtils extends org.junit.Assert {
   ...
   * to the same path use datasets with different character moduli.
   *
   * @param fs filesystem
  ...
  /**
   * /** Assert that a file exists and whose {@link FileStatus} entry declares that this is a file
   * and not a symlink or directory.
   * 
